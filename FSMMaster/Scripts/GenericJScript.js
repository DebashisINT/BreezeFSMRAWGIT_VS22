...
function Height(MaxScrollHeight,FrameElementHeight)
{
    if(document.body.scrollHeight>=parseInt(MaxScrollHeight))
        window.frameElement.height = document.body.scrollHeight;
    else
        window.frameElement.height = FrameElementHeight+'px';
