...
/// </summary>
public class SQLProcedures1
{
    public SQLProcedures1()
    {
    }
    public static DataTable SelectProcedure1(string ProcedureName, string InputName, string OutputName, string InputType, string OutputType, string InputValue)
    {
    ...
    public static DataTable SelectProcedureArr1(string ProcedureName, string[] InputName, string OutputName, string[] InputType, string OutputType, string[] InputValue, ref int OutputValue)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
        DataTable DT = new DataTable();
    ...
    public static DataSet SelectProcedureArrDS1(string ProcedureName, string[] InputName, string OutputName, string[] InputType, string OutputType, string[] InputValue, ref string OutputValue)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
    ...
    public static DataTable SelectProcedureArr1(string ProcedureName, string[] InputName, string[] InputType, string[] InputValue)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
        DataTable DT = new DataTable();
    ...
    public static DataTable InsertProcedureArr1(string ProcedureName, string[] InputName, string OutputName, string[] InputType, string OutputType, string[] InputValue, string tbl_name)
    {
    ...
    public static DataSet SelectProcedureArrDS1(string ProcedureName, string[] InputName, string[] InputType, string[] InputValue)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
        DataSet DS = new DataSet();
    ...
    public static int Execute_StoreProcedure1(string ProcedureName, string[] InputName, string[] InputType, string[] InputValue, string[] InputSize)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
        DataTable DT = new DataTable();
 ...
 //New Procedure For Simple Execute a Procedure and return integer value according your sp..
    public static int Execute_Return_StoreProcedure1(string ProcedureName, string[] InputName, string[] InputType, string[] InputValue, string[] InputSize)
    {
        SqlConnection MyConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["crmConnectionString"].ToString());
        SqlDataAdapter MyDataAdapter = new SqlDataAdapter(ProcedureName, MyConnection);
        DataTable DT = new DataTable();
