...
open:function(t, contenttype, contentsource, title, attr, recalonload){
  ...
  /*
  eshops.cz - commented out to support onclose functionality as available in
  dhtmlwindow and replaced with the following 3 lines.
  See http://www.dynamicdrive.com/forums/showthread.php?p=125396
...
loadveil:function(){
  ...
  /* eshops.cz: added as per http://www.dynamicdrive.com/forums/showthread.php?t=26027&highlight=modal+veil */
  ...
  /* eshops.cz: replaced as per http://www.dynamicdrive.com/forums/showthread.php?t=26027&highlight=modal+veil */
...
/*
  eshops.cz - added new function to support onclose functionality as available in
  dhtmlwindow. See http://www.dynamicdrive.com/forums/showthread.php?p=125396
*/
hide:function(t){
	t.contentDoc=(t.contentarea.datatype=="iframe")? window.frames["_iframe-"+t.id].document : t.contentarea //return reference to modal window DIV (or document object in the case of iframe
	dhtmlwindow.hide(t)
