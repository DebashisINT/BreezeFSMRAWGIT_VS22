...
namespace ERP.OMS.Management.Master
{
    public partial class Section : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Master/Section.aspx");
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    section.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    section.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }
        ...
        {
            string filename = "Section List";
            exporter.FileName = filename;

            exporter.PageHeader.Left = "Section list";
        ...
        protected void DesigGrid_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            int i = masterdata.DeleteSection(Convert.ToString(id));
            if (i == 1)
            {
        ...
        protected void DesigGrid_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            DesigGrid.SettingsText.PopupEditFormCaption = "Edit Section";
            int id = Convert.ToInt32(Convert.ToString(e.EditingKeyValue));
            Session["Desigid"] = id;
        }
        //Purpose: Add Edit and delete rights to Section
        //Name: Debjyoti Dhar.
        ...
        public static bool CheckUniqueCode(string ProductClassCode, string proclassid)
        {
            ...
            {
                status = objMShortNameCheckingBL.CheckUnique(ProductClassCode.Trim(), proclassid, "MasterSection");
            }
            return status;
        }
    }
