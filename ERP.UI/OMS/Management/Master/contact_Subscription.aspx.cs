...
{
    public partial class management_master_contact_Subscription : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void gridSubscription_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            {
                string DataCheckBeforeInsert = oDBEngine.GetFieldValue("Trans_TopicSubscriptions", "TopicSubscriptions_ContactID", "TopicSubscriptions_ContactID='" + Session["KeyVal_InternalID"].ToString() + "' and topicsubscriptions_topiccode='" + cmbDescription.Value.ToString() + "' and topicsubscriptions_deliverymode='" + cmbMode.Value.ToString() + "'", 1)[0, 0];
                string MailId = "";
                string PhoneNo = "";
        ...
        protected void dpDescription_CustomJSProperties(object sender, DevExpress.Web.CustomJSPropertiesEventArgs e)
        {
            e.Properties["cpAccCode"] = acccode.ToString();
        }
        protected void dpMode_CustomJSProperties1(object sender, DevExpress.Web.CustomJSPropertiesEventArgs e)
        {
            e.Properties["cpValueCombo"] = acccode;
        }
