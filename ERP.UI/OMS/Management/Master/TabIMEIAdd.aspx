...
1.0                15-02-2023        V2.0.39          Pallab              Settings/Options module design modification 
====================================================== Revision History ===================================================--%>
            ...
            <div class="p-5">
                <table class="pdtble">
                        ...
                        <tr>
                            ...
                            <td align="left" style="position:relative">
                                <%--Rev 1.0: "form-control" class add--%>
                                <asp:TextBox ID="txtimei" CssClass="form-control" ClientIDMode="Static" runat="server" Width="253px" MaxLength="50" required="required"   ValidationGroup="A"></asp:TextBox>
                                <span id="MandatoryShortname" class="pullleftClass fa fa-exclamation-circle iconRed" style="color:red; position:absolute;right:-12px;top:10px;display:none" title="Mandatory"></span>
