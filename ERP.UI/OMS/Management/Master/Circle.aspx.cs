...
namespace ERP.OMS.Management.Master
{
    public partial class Circle : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Master/Circle.aspx");
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    circle.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    circle.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }
        ...
        {
            string filename = "Circle List";
            exporter.FileName = filename;

            exporter.PageHeader.Left = "Circle list";
        ...
        protected void DesigGrid_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            int i = masterdata.DeleteCircle(Convert.ToString(id));
            if (i == 1)
            {
        ...
        protected void DesigGrid_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            ...
            DesigGrid.SettingsText.PopupEditFormCaption = "Edit Circle";
            int id = Convert.ToInt32(Convert.ToString(e.EditingKeyValue));
            Session["Desigid"] = id;
        }
        //Purpose: Add Edit and delete rights to Circle
        //Name: Debjyoti Dhar.
        ...
        public static bool CheckUniqueCode(string ProductClassCode, string proclassid)
        {
            ...
            {
                status = objMShortNameCheckingBL.CheckUnique(ProductClassCode.Trim(), proclassid, "MasterCircle");
            }
            return status;
        }
    }
