...
var ajax_list_externalFile = '';//'../../../CentralData/Pages/ajax_list.aspx';	// Path to external file
...
function ajax_showOptions(inputObj, paramToExternalFile, e, obj_search, searchStart, GenericAjaxListAspxPath) {
    mainsub = searchStart;
    ajax_list_externalFile = GenericAjaxListAspxPath;
