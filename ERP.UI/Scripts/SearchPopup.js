            ...
            for (x in myObj) {
                ...
                for (key in myObj[0]) {
                    ...
                    if (PropertyCount == 0)
                        ...
                        txt += " <td><input onclick='PopupTextClick(event," + onSelect + ")' type='text' style='background-color: #3399520a; width:100%;'" + UniqueIndex + "='" + count + "'onfocus='searchElementGetFocus(event)'  onblur='searchElementlostFocus(event)' onkeydown=ValueSelected(event,'" + UniqueIndex.toString() + "') readonly value='" + myObj[x][key] + "'/></td>";
                    else
