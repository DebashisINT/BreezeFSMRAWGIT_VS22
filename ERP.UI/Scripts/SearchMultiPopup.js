...
function callonServerMS(serviceurl, objectToPass, TargetID, HeaderCaption, UniqueIndex, onSelect, ArrName) {
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (x in myObj) {
                ...
                var arr = $.grep(arrMultiPopup, function (element) { return element.Name == ArrName });
                var selectedarr = $.grep(arr, function (element) { return element.Id == myObj[x].id; });
