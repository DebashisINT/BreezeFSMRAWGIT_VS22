...
/// <summary>
/// Summary description for Insurance_Life
/// </summary>

namespace BusinessLogicLayer
{
    public class Insurance_Life
    {
        public Insurance_Life()
        {
            //
        ...
        public string Insert_InsuranceLife(string vDescription, string vNameOfCompany, string vIPlanType, string vIRDAUIN,
                                             ...
                                             )
        {
            ...
            try
            {
                ...
                using (proc = new ProcedureExecute("InsuLifeInsert"))
                {
