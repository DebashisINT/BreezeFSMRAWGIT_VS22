...
{
    public class SalesmanIMEI
    {

       public DataTable GetBranchdetails()
       {
           DataTable ds = new DataTable();
           ProcedureExecute proc = new ProcedureExecute("Proc_IMEI_SalemanUser");
       ...
       public int InsertImei(IMEISalemanClass model)
       {
