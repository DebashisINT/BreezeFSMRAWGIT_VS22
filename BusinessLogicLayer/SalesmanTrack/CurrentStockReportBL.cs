...
{
   public class CurrentStockReportBL
    {
       public DataTable GetReportCurrentStock(string fromdate, string todate, string userid, String stateID, String userlist, String ShopId)
       {
