...
{
    public class CompetitorStockRegisterBL
    {
        public DataTable GetReportCompetitorStock(string fromdate, string todate, string userid, String stateID, String userlist, String ShopId)
        {
            DataTable ds = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("PRC_FTSCOMPETITORSTOCK_REPORT");
