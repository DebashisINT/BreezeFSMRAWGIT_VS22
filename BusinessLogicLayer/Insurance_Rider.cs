...
/// <summary>
/// Summary description for Insurance_Rider
/// </summary>
namespace BusinessLogicLayer
{
    public class Insurance_Rider
    {
        public Insurance_Rider()
        {
            //
        ...
        public string Insert_InsuranceRider(string vDescription, string vNameOfCompany, string vIPlanType, string vIRDAUIN,
                                            ...
                                            )
        {
            ...
            try
            {
                ...
                using (proc = new ProcedureExecute("RiderInsert"))
                {
