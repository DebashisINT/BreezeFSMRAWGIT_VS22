...
namespace MyShop.Models
{
    ...
    public class PrimarySalesOrder1ststage
    {
    ...
    public class PrimarySalesOrder2ndstage
    {
        public int SEQ { get; set; }
        public String FROM_DATE { get; set; }
        public String TO_DATE { get; set; }
    ...
    public class PrimarySalesOrder3rdstage
    {
        public int SEQ { get; set; }
    ...
    public class PrimarySalesOrder4thstage
    {
        public int SEQ { get; set; }
