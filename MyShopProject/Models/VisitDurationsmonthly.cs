...
{
    public class DurationshpsDate
    {
        public string Date { get; set; }
    }
    public class VisitsDurationhopReportInput
    {
        public int Month { get; set; }
        public string Year { get; set; }
    }

    public class MonthlyVisitDurationReportOutput
    {
        public List<VisitDurationReport> visitduration { get; set; }
        public List<DateormatsmontwiseDuration> dates { get; set; }

    }

    public class VisitDurationReport
    {
        ...
        public decimal TotaldShopspentdurationCal { get; set; }
    }

    public class DateormatsmontwiseDuration
    {
        public string datevisit { get; set; }
    }

    public class UserformatsDuration
    {
        public int user_id { get; set; }
