    ...
    public class AttendanceListController : Controller
    {
        ...
        public ActionResult GetAttendanceList(UserwiseattendanceInput model)
        {
            try
            {
                ...
                List<AttendanceListModel> omel = new List<AttendanceListModel>();
                ...
                dt = objshop.GetAttendanceList(model.DesgId, datfrmat, dattoat, model.type, Int32.Parse(model.selectedusrid));
                ...
                if (dt.Rows.Count > 0)
                {
                    omel = APIHelperMethods.ToModelList<AttendanceListModel>(dt);
                    TempData["Exportattendanceuserwise"] = omel;
                    TempData.Keep();
                }
                else
                {
                    return PartialView("_PartialAttendanceList", omel);
        ...
        public ActionResult ExportAttendanceList(int type)
        {
        ...
        private GridViewSettings GetEmployeeBatchGridViewSettings()
        {
            ...
            settings.Columns.Add(column =>
                 {
                     column.Caption = "Leave Status";
                     column.FieldName = "Isonleave";
