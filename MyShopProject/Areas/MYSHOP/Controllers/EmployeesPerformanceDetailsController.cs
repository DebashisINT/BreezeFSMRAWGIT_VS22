...
{
    public class EmployeesPerformanceDetailsController : Controller
    {
        ...
        {
            return PartialView("PartialGetSalesSummaryList", GetEmpPerformanceSummary("0"));
        }
        public ActionResult GetEmployeeParformanceList(SalesSummaryReport model)
        {
            try
            {
                ...
                if (days <= 30)
                {
                    dt = objgps.GetEmployeePerformanceReport(datfrmat, dattoat, Userid, state, desig, empcode);
                }

                return PartialView("PartialGetPerformanceSummary", GetEmpPerformanceSummary(frmdate));
        ...
        public IEnumerable GetEmpPerformanceSummary(string frmdate)
        {
            DataTable dtColmn = objgps.GetPageRetention(Session["userid"].ToString(), "EMPLOYEE PERFORMANCE");
            ...
            if (frmdate != "Ispageload")
            {
                ...
                var q = from d in dc.FTSEMPLOYEEPERFORMANCEDETAILS_REPORTs
        ...
        public ActionResult ExporEmpPerformanceList(int type)
        {
            switch (type)
            {
                case 1:
                    return GridViewExtension.ExportToPdf(GetEmployeeBatchGridViewSettings(), GetEmpPerformanceSummary(""));
                //break;
                case 2:
                    return GridViewExtension.ExportToXlsx(GetEmployeeBatchGridViewSettings(), GetEmpPerformanceSummary(""));
                //break;
                case 3:
                    return GridViewExtension.ExportToXls(GetEmployeeBatchGridViewSettings(), GetEmpPerformanceSummary(""));
                case 4:
                    return GridViewExtension.ExportToRtf(GetEmployeeBatchGridViewSettings(), GetEmpPerformanceSummary(""));
                case 5:
                    return GridViewExtension.ExportToCsv(GetEmployeeBatchGridViewSettings(), GetEmpPerformanceSummary(""));
                //break;
        ...
        private GridViewSettings GetEmployeeBatchGridViewSettings()
        {
            ...
            settings.Name = "EmpPerformanceReport";
            settings.CallbackRouteValues = new { Controller = "EmployeesPerformanceDetails", Action = "GetEmployeeParformanceList" };
            // Export-specific settings
            settings.SettingsExport.ExportedRowType = GridViewExportedRowType.All;
            settings.SettingsExport.FileName = "Employee Performance";
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "GPTPLNAME";
                x.Caption = "GPTPL/Distributor";
                x.VisibleIndex = 19;
            });
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "ELECTRICIAN";
                x.Caption = "Electrician";
                x.VisibleIndex = 22;
            });
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "GPTPLADD";
                x.Caption = "GPTPL/Dist. Address";
                x.VisibleIndex = 27;
            });

            settings.Columns.Add(x =>
            {
                x.FieldName = "GPTPLMOB";
                x.Caption = "GPTPL/Dist. Mobile no.";
                x.VisibleIndex = 28;
            });

            settings.Columns.Add(x =>
            {
                x.FieldName = "ELECTRICIANADD";
                x.Caption = "Electrician Address";
                x.VisibleIndex = 29;
            });

            settings.Columns.Add(x =>
            {
                x.FieldName = "ELECTRICIANMOB";
                x.Caption = "Electrician Mobile no.";
                x.VisibleIndex = 30;
            });
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "SHPVISITTIME";
                x.Caption = "Visit Time";
                x.VisibleIndex = 33;
            });
        ...
        public ActionResult PageRetention(List<String> Columns)
        {
            try
            {
                ...
                int k = objgps.InsertPageRetention(Col, Session["userid"].ToString(), "EMPLOYEE PERFORMANCE");
