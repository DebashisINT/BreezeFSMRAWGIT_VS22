...
namespace MyShop.Areas.MYSHOP.Controllers
{
    ...
    {
        ActivityMasterBL obj = new ActivityMasterBL();
        ...
        {
            String Activity = "";
            DataTable dt = obj.GetActivity(ActivityID, "", "EDIT");
        ...
        {
            String Activity = "";
            DataTable dt = obj.GetActivity(ActivityID, "", "DELETE");
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public ActionResult AddActivity(string ActivityID, String ActivityName)
        {
            ...
            DataTable dt = obj.GetActivity(ActivityID, ActivityName, Actions);
            if (dt != null && dt.Rows.Count > 0)
            {
                Activity = dt.Rows[0]["msg"].ToString();
            }
