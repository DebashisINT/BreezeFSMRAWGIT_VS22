...
{
    public class RevisitVarianceDetailsController : Controller
    {
        //
        // GET: /MYSHOP/RevisitVarianceDetails/
        UserList lstuser = new UserList();
        RevisitVariance objgps = new RevisitVariance();

        public ActionResult GetRevisitVarianceDetailsList()
        {
            try
            {
        ...
        //{
        //    return PartialView("PartialRevisitVarianceDetails", GetRevisitVarianceDetails("0"));
        //}
        public ActionResult GetRevisitVarianceDetailsListPopulate(SalesSummaryReport model)
        {
            try
            {
                ...
                dt = objgps.GetRevisitVarianceSumDetReport(datfrmat, dattoat, Userid, state, desig, empcode, "Details");

                return PartialView("PartialRevisitVarianceDetails", GetRevisitVarianceLinq(frmdate));
        ...
        public IEnumerable GetRevisitVarianceLinq(string frmdate)
        {
            ...
            if (frmdate != "Ispageload")
            {
                ...
                var q = from d in dc.FTSEMPLOYEEREVISITVARIANCESUMMDET_REPORTs
                        where d.USERID == Convert.ToInt32(Userid) && d.REPORTTYPE=="Details"
        ...
        public ActionResult ExporRevisitVarianceDetailsList(int type)
        {
            switch (type)
            {
                case 1:
        ...
        private GridViewSettings GetEmployeeBatchGridViewSettings()
        {
            ...
            settings.Name = "Revisit Variance - Details";
            settings.CallbackRouteValues = new { Controller = "RevisitVarianceDetails", Action = "GetRevisitVarianceDetailsListPopulate" };
            // Export-specific settings
            settings.SettingsExport.ExportedRowType = GridViewExportedRowType.All;
            settings.SettingsExport.FileName = "Revisit Variance - Details";
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "SHOPSTAT";
                x.Caption = "Shop State";
                x.VisibleIndex = 9;
            });
            ...
            settings.Columns.Add(x =>
            {
                ...
                x.Caption = "Shop Revisit Target Date";
                x.VisibleIndex = 11;
            });
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "NEWVISITDATE";
                x.Caption = "New Visit Date";
                x.VisibleIndex = 14;
            });
