...
{
    public class Leave_DashboardReportController : Controller
    {
        ...
        private GridViewSettings GetEmployeeBatchGridViewSettings()
        {
            ...
            settings.CallbackRouteValues = new { Controller = "Leave_DashboardReport", Action = "GetSalesSummaryList" };
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "LEAVEDATE";
                //x.Caption = "Leave Date";
                x.Caption = "Applied Leave Date";
