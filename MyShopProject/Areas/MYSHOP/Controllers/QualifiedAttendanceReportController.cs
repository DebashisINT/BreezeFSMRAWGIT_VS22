...
{
    public class QualifiedAttendanceReportController : Controller
    {
        //
        // GET: /MYSHOP/QualifiedAttendanceReport/
        public ActionResult QualifiedAttendanceReport()
        {
            try
            {
        ...
        public PartialViewResult QualifiedAttendanceReportGridViewCallback(TeamVisitModel model)
        {
            ...
            if (model.is_pageload != "0" && model.is_pageload != null)
            {
                ...
                if (days <= 35)
                {
                    ProcedureExecute proc = new ProcedureExecute("PRC_FTSQUALIFIEDATTENDANCE_REPORT");
        ...
        private GridViewSettings GetDashboardGridView(object dataset)
        {
            ...
            settings.Name = "Qualified Attendance";
            settings.SettingsExport.ExportedRowType = GridViewExportedRowType.All;
            settings.SettingsExport.FileName = "QualifiedAttendance";
