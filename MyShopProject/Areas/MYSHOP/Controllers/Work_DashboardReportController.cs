...
{
    public class Work_DashboardReportController : Controller
    {
        ...
        private GridViewSettings GetEmployeeBatchGridViewSettings()
        {
            ...
            settings.CallbackRouteValues = new { Controller = "Work_DashboardReport", Action = "GetSalesSummaryList" };
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "DISTANCE_COVERED";
                x.Caption = "K.M. Travelled";
            ...
            settings.Columns.Add(x =>
            {
                x.FieldName = "SHOPS_VISITED";
                x.Caption = "Total Shop Visited";
                x.HeaderStyle.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Right;
                x.Width = System.Web.UI.WebControls.Unit.Pixel(150);
            });
